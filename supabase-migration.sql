/*
  ...
  ## Initial Data
  - Creates one admin user with default password hash (password: "admin123" - CHANGE THIS!)
  ...
  5. Click "Run"
  6. IMPORTANT: Change the admin password by updating the password_hash in admin_users table
*/
...
-- This is a simple MD5 hash for demonstration
INSERT INTO admin_users (password_hash)
VALUES ('5f4dcc3b5aa765d61d8327deb882cf99')
